...
export default function About(){
  ...
  const waMessage = encodeURIComponent('Hola me podrias dar mas informacion sobre la guarida y lo que ofrece ? Gracias !')
  ...
  return (
    <section id="about-section" className="mt-14 md:mt-24 rounded-2xl border border-white/10 bg-gradient-to-b from-white/95 to-white/90 dark:from-[#0b0c10] dark:to-[#08090d] shadow-[0_18px_48px_rgba(0,0,0,0.16)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-9 sm:py-12 md:py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7 md:gap-10 items-start">
          <div className="md:col-span-2">
            <p className="text-[11px] sm:text-xs uppercase tracking-[0.22em] text-[#b6892f] dark:text-[#d4a43b] font-semibold mb-3">Sobre La Guarida</p>
            <h2 className="text-[1.9rem] sm:text-3xl md:text-[3.2rem] font-extrabold text-gray-900 dark:text-white leading-[1.07] mb-4 md:mb-5">Una tienda, una historia</h2>
            ...
            <h3 className="text-[1.05rem] sm:text-xl font-semibold text-gray-900 dark:text-white mb-3 md:mb-4">Hecho por un músico, para músicos</h3>
          ...
          <aside className="md:col-span-1 bg-white/85 dark:bg-[#17181d] p-4 sm:p-6 rounded-2xl border border-gray-200/80 dark:border-white/10 shadow-[0_10px_26px_rgba(0,0,0,0.1)]">
            <h4 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3 md:mb-4">Contacto rápido</h4>
            ...
            <h5 className="text-[12px] sm:text-sm font-medium text-gray-900 dark:text-white mb-1.5 md:mb-2">Nuestro espacio</h5>
            ...
            <h5 className="text-[12px] sm:text-sm font-medium text-gray-900 dark:text-white mb-1.5 md:mb-2">Horarios</h5>
            ...
            <div className="mt-2 md:mt-3">
              <p className="text-[12px] sm:text-sm font-medium text-gray-900 dark:text-white mb-1.5 md:mb-2">Síguenos</p>
        ...
        <div className="mt-9 md:mt-11 flex justify-center">
          <a
            href="/"
            onClick={scrollToTop}
            className="inline-flex items-center justify-center min-h-[46px] px-7 rounded-xl border border-black/10 dark:border-white/20 bg-[#f5f1e6] text-[#111319] text-sm font-semibold hover:bg-[#efe7d6] transition-colors"
          >
            Volver al home
          </a>
        </div>
