                  ...
                  <div>
                    ...
                    {modalForm.image_url ? (
                      <div className="w-full rounded-xl overflow-hidden border border-white/15 mb-2 relative h-40">
                        <ImageWithSkeleton src={modalForm.image_url} alt="Imagen principal" fill quality={70} className="w-full h-full" disableClientPreview />
                        {modalUploadingMain ? (
                    ...
                    <div className="mt-3 grid grid-cols-3 sm:grid-cols-4 gap-2">
                      {modalGalleryPreviews.map((p, i) => (
                        <div key={p.id} className="w-full">
                          ...
                          >
                            <ImageWithSkeleton src={p.url} alt={p.name || ('Imagen ' + (i+1))} fill quality={68} className="w-full h-full" disableClientPreview />
                            {p.uploading ? (
                              <div className="absolute inset-0 bg-black/35 flex items-center justify-center">
