...
const DISPLAY_PRESETS = {
  /** Grid / cards: peso menor, suficiente nitidez en viewport típico */
  card: { width: 768, quality: 68 },
  hero: { width: 1920, quality: 72 },
  carousel: { width: 900, quality: 70 },
  galleryMain: { width: 2400, quality: 72 },
  galleryThumb: { width: 900, quality: 68 },
  lightbox: { width: 2560, quality: 80 },
}
