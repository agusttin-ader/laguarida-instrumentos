      ...
      <div className={`${layoutShellClassName} px-4 sm:px-5 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-11`}>
        <ScrollReveal threshold={0.08} rootMargin="0px 0px -8% 0px">
          <div className="w-full">
            ...
            <p className="text-[14px] sm:text-base text-gray-700 dark:text-gray-200 mb-5 md:mb-6 leading-relaxed max-w-3xl max-[768px]:hidden">
              Una tienda, una historia dedicada a las guitarras, a las búsquedas sonoras y a quienes las tocan.
            </p>
            <p className="hidden max-[768px]:block text-[14px] text-gray-200 mb-4 leading-relaxed max-w-3xl">
            ...
            <div className="hidden max-[768px]:block prose prose-sm max-w-none text-gray-200 text-[14px] [&>p]:leading-relaxed [&>p]:mb-0">
              <p>
            ...
            <div className="prose prose-sm max-w-none text-gray-700 dark:text-gray-200 text-[14px] sm:text-base lg:prose-base max-[768px]:hidden [&>p]:leading-[1.86] [&>p]:mb-3 md:[&>p]:mb-3.5">
