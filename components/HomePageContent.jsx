  ...
  return (
    <>
      ...
      <section
        ...
        className="w-full bg-gradient-to-b from-[var(--dark-bg-page)] via-[var(--dark-bg-page)] to-[var(--dark-bg-page)] pt-6 max-md:pt-5 sm:pt-8 md:pt-10 pb-2 max-md:pb-1.5 sm:pb-4 md:pb-5"
      >
      ...
      <section
        ...
        className={`${layoutShellClassName} w-full px-4 sm:px-5 md:px-8 lg:px-10 min-[1920px]:px-12 min-[2560px]:px-14 pt-1 pb-4 sm:pb-6 md:pb-7 md:pt-2 border-t border-white/[0.06]`}
      >
        <HomeBrandGrid />
      </section>

      <div
        className={`${layoutShellClassName} px-4 sm:px-5 md:px-8 lg:px-10 pt-0 pb-3 sm:pb-5 md:pb-6 min-[1920px]:px-12 min-[2560px]:px-14 max-[767px]:pb-0`}
      >
        <p className="sr-only">
