...
export default function FeaturedSelection({ items = [], loading = false }) {
  return (
    <div className="home-featured-section w-full">
      <header className={`${layoutShellClassName} mb-6 w-full min-w-0 px-4 sm:mb-8 sm:px-5 md:mb-10 md:px-8 lg:px-10 min-[1920px]:px-12 min-[2560px]:px-14`}>
        <p className="section-kicker-minimal section-underline-ocre mb-2 text-[var(--palette-gold)]">Curaduría semanal</p>
        <h2
          id="destacados-heading"
          className="section-title-minimal text-[var(--dark-text-primary)] text-2xl sm:text-3xl md:text-[2.75rem]"
        >
          Piezas de alta gama
        </h2>
        <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-[var(--dark-muted)] md:text-base">
