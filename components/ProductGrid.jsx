...
export default function ProductGrid({
  ...
  if (isLoading) {
    return (
      <div className="w-full min-w-0">
        ...
        <div className="grid w-full min-w-0 grid-cols-1 gap-6 max-md:gap-6 md:grid-cols-2 md:gap-5 lg:grid-cols-3 lg:gap-8" aria-hidden>
  ...
  return (
    <div className="w-full min-w-0">
      ...
      <div className="product-grid--mobile-enter grid w-full min-w-0 auto-rows-fr grid-cols-1 items-stretch gap-6 max-md:gap-6 md:grid-cols-2 md:gap-5 lg:grid-cols-3 lg:gap-8">
