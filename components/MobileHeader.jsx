    ...
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-sm border-b h-14 flex items-center px-4 transition-colors duration-300 ${
        ...
        <button
          ...
          aria-expanded={open}
          onClick={() => setOpen((s) => !s)}
          className="w-10 h-10 flex items-center justify-center rounded-md text-neutral-900 dark:text-neutral-100 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition"
        >
        ...
        <div className="absolute left-1/2 -translate-x-1/2">
          <a href="/" aria-label="Inicio" className="inline-block">
            <Image src="/images/logo/logo-fondo-claro.PNG" alt="La Guarida" width={140} height={36} quality={100} className="object-contain block h-auto" />
          </a>
        </div>
