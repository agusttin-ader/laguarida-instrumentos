...
export const DISPLAY_PRESETS = {
  /** Grid / cards: ~2× viewport típico (~320–480px), sin exceso en retina */
  card: { width: 640, quality: 62 },
  hero: { width: 1600, quality: 70 },
  carousel: { width: 800, quality: 65 },
  /** Ficha producto: nitidez en pantallas grandes sin servir 4K al layout */
  galleryMain: { width: 1920, quality: 74 },
  galleryThumb: { width: 640, quality: 62 },
  lightbox: { width: 2048, quality: 78 },
  adminThumb: { width: 128, quality: 58 },
}
 ...
 * @param {'card'|'hero'|'carousel'|'galleryMain'|'galleryThumb'|'lightbox'|'adminThumb'} [variant]
 */
