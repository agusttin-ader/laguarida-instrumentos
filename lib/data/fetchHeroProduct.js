...
/**
 * Si hay SERVICE_ROLE, genera URL firmada (útil con bucket privado).
 * Si falla o no hay admin, devuelve la URL pública original.
 */
...
export async function fetchHeroProduct() {
  try {
    ...
    const picked = pickFeaturedFromRows(data, dayKey)
